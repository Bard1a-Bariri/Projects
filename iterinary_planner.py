...
if submit_button:
    ...
    if len(st.session_state.form_dates) < 2:
    ...
    if st.session_state.itinerary_data is not None:
        ...
        with tab2:
            ...
            st_folium(base_map, width=700, height=450, key="itinerary_map")
        ...
        if forecast_list and len(forecast_list) > 0:
            ...
            cols = st.columns(min(len(forecast_list), 7))
        ...
        with tab4:
            ...
            success_score = predict_budget_success(
